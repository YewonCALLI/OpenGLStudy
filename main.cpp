...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(width, height, "OpenGL Study", NULL, NULL);
	if (window == NULL)
	{
	...
	// Texture
	Texture popCat((parentDir + texPath + "brick.png").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
